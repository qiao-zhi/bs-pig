var pageUrl = "/appro/page.html";
var deleteUrl = "/appro/delete.html";
var updateUrl = "/appro/update.html";
...
function showTable(pageInfo) {
    ...
    for(var i=0,length_1 = users.length;i<length_1;i++){
        ...
        var tr = "<tr>"
            +'<td>'+index+'</td>'
            +'<td>'+replaceNull(users[i].healthy)+'</td>'
            +'<td>'+replaceNull(users[i].supplyQuantity)+'</td>'
            +'<td>'+replaceNull(users[i].price)+'</td>'
