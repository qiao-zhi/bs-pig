var pageUrl = "/appro2/page.html";
var deleteUrl = "/appro2/delete.html";
var updateUrl = "/appro2/update.html";
...
function showTable(pageInfo) {
    ...
    for(var i=0,length_1 = users.length;i<length_1;i++){
        ...
        var tr = "<tr>"
            +'<td>'+index+'</td>'
            +'<td>'+replaceNull(users[i].pigletNumber)+'</td>'
            +'<td>'+replaceNull(users[i].pigHealth)+'</td>'
            +'<td>';
	        if(isAdmin()){
