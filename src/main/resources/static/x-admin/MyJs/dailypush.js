var pageUrl = "/dailypush/page.html";
var deleteUrl = "/dailypush/delete.html";
var updateUrl = "/dailypush/update.html";
...
function showTable(pageInfo) {
    ...
    for(var i=0,length_1 = users.length;i<length_1;i++){
        ...
        var tr = "<tr>"
            +'<td>'+index+'</td>'
            +'<td>'+replaceNull(users[i].virus)+'</td>'
            +'<td>'+replaceNull(users[i].address)+'</td>'
            +'<td>'+replaceNull(users[i].priceAttend)+'</td>'
            +'<td>'+replaceNull(users[i].clause)+'</td>'
            +'<td>'+replaceNull(users[i].rules)+'</td>'
            +'<td>';
	        if(isAdmin()){
